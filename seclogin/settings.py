"""
Django settings for seclogin project.
...
SECRET_KEY = 'django-insecure-4yl-!wi7gh(k@ocpvp*2*s+b+k1!%&(hkge(c7ob86vq5mip0q'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('PG_DB', 'seclogin'),
